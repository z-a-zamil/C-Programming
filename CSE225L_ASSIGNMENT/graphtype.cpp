...
/* new code */
template<class VertexType>
void GraphType<VertexType>::DepthFirstSearch(VertexType startVertex, VertexType endVertex, int& cost, QueType<VertexType>& pathQue)
{
	...
	for (int i = 0; i < count; i++) {
		pathQue.Enqueue(arr[i]);
		if(i != (count-1))
			cost += WeightIs(arr[i], arr[i + 1]);
	}

}
/* new code */
template<class VertexType>
void GraphType<VertexType>::BreadthFirstSearch(VertexType startVertex, VertexType endVertex, int& cost, QueType<VertexType>& pathQue)
{
...
/* new code */
template<class VertexType>
void GraphType<VertexType>::StronglyConnect(VertexType startVertex, VertexType endVertex, bool& found) {
	QueType<VertexType> queue;
	QueType<VertexType> vertexQ;
	found = false;
	VertexType vertex, item;
