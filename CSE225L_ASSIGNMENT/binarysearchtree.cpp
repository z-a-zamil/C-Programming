...
template <class ItemType>
int heightBST(TreeNode<ItemType>* tree)
{
	if (tree == NULL)
		return 0;
	else
	{
		int left_tree= heightBST(tree->left);

		int right_tree = heightBST(tree->right);
...
template <class ItemType>
int TreeType<ItemType>::CountLeaveNodes() {
	return	CountLeaves(root);
}
template <class ItemType>
void TreeType<ItemType>::PrintByLevel()
{
	TreeNode<ItemType>* tree;
	QueType<TreeNode<ItemType>*> que;
	que.Enqueue(root);
